...
<template>
  <!-- Navbar -->
  <nav class="editornavbar bg-white dark:bg-slate-900">
    <div class="px-6 py-4 mx-auto flex justify-between items-center">
      <div class="flex items-center justify-between">
        <div>
          <a
            class="logoitemnav text-2xl font-bold text-gray-900 dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300"
            href="https://devambience.web.app/"
          >CodEditor <span class="mini__text">Dev Ambience</span></a>
        </div>
      </div>
